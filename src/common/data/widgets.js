...
const tileBoxs2 = [
    {
        ...
        prefix: "",
        bgColor: "#014a92",
        // "#f8f9fa", // Couleur par défaut/gris clair pour celui non spécifié
        textColor: "#ffffff" // Bleu foncé comme le titre
    },
    {
        id: 2,
        label: "DEPENSES ANNUELLES",
        ...
        suffix: "k",
        prefix: "$",
        bgColor: "#085dbc", // Bleu moyen comme dans l'image
        textColor: "#ffffff" // Texte blanc pour contraste
    },
    {
        id: 3,
        label: "BENEFICES ANNUELS",
        badge: "ri-arrow-down-circle-line text-primary",
        icon: "ri-pulse-line",
        counter: "32.89",
        decimals: 2,
        suffix: "%",
        prefix: "",
        bgColor:  "#52a101",
        // "#52a101", // Vert comme dans l'image
        textColor: "#ffffff",
        // "#ffffff" // Texte blanc pour contraste
    },
    {
        id: 4,
        label: "CREANCES CLIENTS",
        ...
        separator: ",",
        suffix: "",
        bgColor: "#085dbc", // Couleur par défaut/gris clair
        textColor: "#ffffff" // Bleu foncé
    },
    {
        id: 5,
        label: "VOS DETTES",
        ...
        suffix: "",
        prefix: "",
        bgColor: "#014a92", // Bleu foncé comme dans l'image
        textColor: "#ffffff" // Texte blanc pour contraste
    },
];
