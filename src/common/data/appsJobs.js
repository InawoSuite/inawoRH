...
const jobGrid = [
  {
    id: 1,
    companyLogo: cimg1,
    jobTitle: "Formation Éducative",
    companyName: "Micro Design",
    location: "Escondido, Californie",
    postDate: "15 Sept, 2022",
    description:
      "En tant que Designer Produit, vous travaillerez au sein d'une équipe de livraison de produits fusionnant UX, ingénierie, produit et données.",
    requirement: ["Temps plein", "Freelance", "Urgent"],
    status: "Actif",
  },
  {
    id: 2,
    companyLogo: cimg2,
    jobTitle: "Développeur Magento",
    companyName: "Themesbrand",
    location: "Stordorf, Allemagne",
    postDate: "15 Sept, 2022",
    description:
      "En tant que Designer Produit, vous travaillerez au sein d'une équipe de livraison de produits fusionnant UX, ingénierie, produit et données.",
    requirement: ["Temps partiel", "Freelance"],
    status: "Nouveau",
  },
  {
    id: 3,
    ...
    companyName: "Themesbrand",
    location: "Cullera, Espagne",
    postDate: "14 Sept, 2022",
    description:
      "En tant que Designer Produit, vous travaillerez au sein d'une équipe de livraison de produits fusionnant UX, ingénierie, produit et données.",
    requirement: ["Temps plein", "Privé"],
    status: "Actif",
  },
  {
    id: 4,
    ...
    location: "Haren, Allemagne",
    postDate: "13 Sept, 2022",
    description:
      "En tant que Designer Produit, vous travaillerez au sein d'une équipe de livraison de produits fusionnant UX, ingénierie, produit et données.",
    requirement: ["Temps plein", "Freelance", "Urgent"],
    status: "Nouveau",
  },
  {
    ...
    location: "Vinninga, Suède",
    postDate: "13 Sept, 2022",
    description:
      "En tant que Designer Produit, vous travaillerez au sein d'une équipe de livraison de produits fusionnant UX, ingénierie, produit et données.",
    requirement: ["Temps partiel"],
    status: "Actif",
  },
  {
    id: 6,
    ...
    companyName: "Themesbrand",
    location: "Zhoukou, Chine",
    postDate: "12 Sept, 2022",
    description:
      "En tant que Designer Produit, vous travaillerez au sein d'une équipe de livraison de produits fusionnant UX, ingénierie, produit et données.",
  ...
  },
  {
    ...
    companyName: "Syntyce Solutions",
    location: "Boroaia, Roumanie",
    postDate: "11 Sept, 2022",
    description:
      "En tant que Designer Produit, vous travaillerez au sein d'une équipe de livraison de produits fusionnant UX, ingénierie, produit et données.",
    requirement: ["Temps plein"],
    status: "Actif",
  },
  // {
  //   id: 8,
...
const overviewJobs = [
  ...
  },
  {
    id: 2,
    companyLogo: cimg2,
    jobTitle: "Spécialiste Vente de Produits",
    companyName: "Themesbrand",
    location: "Stordorf, Allemagne",
    time: "il y a 10 min",
    postDate: "15 Sept, 2022",
...
const jobApplication = [
...

  {
    id: 13,
    appid: "#VZ006",
    company: [vente, "Syntyce Solutions "],
    designation: "Project Manager",
    date: "28 Sep, 2022",
    contacts: "803-740-3309",
    type: "Part Time",
...

  {
    id: 14,
    appid: "#VZ006",
    company: [stock, "Syntyce Solutions "],
    designation: "Project Manager",
    date: "28 Sep, 2022",
    contacts: "803-740-3309",
    type: "Part Time",
...

  {
    id: 15,
    appid: "#VZ006",
    company: [recruiment, "Syntyce Solutions "],
    designation: "Project Manager",
    date: "28 Sep, 2022",
    contacts: "803-740-3309",
    type: "Part Time",
...

  {
    id: 16,
    appid: "#VZ006",
    company: [globale, "Syntyce Solutions "],
    designation: "Project Manager",
    date: "28 Sep, 2022",
    contacts: "803-740-3309",
    type: "Part Time",
