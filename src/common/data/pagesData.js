...
// pricing1.js - Données mises à jour selon le document PDF

 const pricing1 = [
    {
        id: 1,
        type: "Essentiel",
        purpose: "Pour les petites entreprises qui commencent.",
        ...
        rateYear: "0",
        delrateYear: "1500",
        // Nouvelles propriétés selon le PDF
        users: "0",
...
// Données spécifiques pour InawoStock
 const pricingStock = [
    {
        id: 1,
        type: "Essentiel",
        ...
        rateYear: "0",
        delrateYear: "0",
        // Nouvelles propriétés spécifiques à Stock
        users: "0",
        analyseTempsReel: true,
        tableauBord: true,
        gestionProduits: "Illimité",
...
// Données spécifiques pour InawoGlobal
 const pricingGlobal = [
     {
        id: 1,
        type: "Essentiel",
        ...
        rate: "11",
        rate2: "6 500",
        projects: "05 utilisateurs",  // <-- CHANGÉ de "0 utilisateur" à "05 utilisateurs"
        GestionContacts: "500 contacts",
        supportClass: "success",
        supportClassSymbol: "checkbox",
        storageClass: "success",
        ...
        rateYear: "108",
        delrateYear: "65 000",
        // Nouvelles propriétés spécifiques à Global
        users: "05",  // <-- CHANGÉ de "0" à "05"
        analyseTempsReel: true,
        tableauBord: true,
        gestionProduits: "Illimité",
        factures: "Illimité",
...
export { gallery, pricing1, pricingStock, pricingGlobal, pricing2, pricing3, projects, documents, SearchGallery, news, video, swiper, team };