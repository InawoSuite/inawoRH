...
const Pointage = () => {
    ...
    // Types de pointage
    const pointageTypes = [
        { value: "normal", label: t("Normal"), color: "success" },
        { value: "retard", label: t("Retard"), color: "warning" },
        { value: "absence", label: t("Absence"), color: "danger" },
        { value: "conges", label: t("Congés"), color: "info" },
        { value: "mission", label: t("Mission"), color: "primary" },
        { value: "teletravail", label: t("Télétravail"), color: "secondary" },
    ];
    ...
    document.title = t("Pointage & Présences | INAWO - Suite de Gestion");
        ...
        <div>
                                ...
                                <Col md={3} className="text-end">
                                    <ButtonGroup>
                                        ...
                                        >
                                            ...
                                            {autoMode.enabled ? t('Auto actif') : t('Auto inactif')}
                                        </Button>
                                        {/* <Button 
                                                color="info" 
            ...
            {viewMode === "calendar" && (
                <Row>
                    ...
                    <Col lg={4}>
                        <Card className="rounded-4">
                            <CardBody>
                                <h5 className="card-title mb-3">{t('Pointage rapide')}</h5>
                                <div className="text-center mb-4">
                                    <div className="bg-light rounded-4 p-4 position-relative">
                                        ...
                                        <h6 className="mt-3">{t('Scanner un badge')}</h6>
                                        <p className="text-muted small">
                                            {t('Utilisez le lecteur de badge ou saisissez le numéro')}
                                        </p>
                                    </div>
                                </div>

                                <div className="mb-3">
                                    <label className="form-label">{t('Numéro de badge')}</label>
                                    <div className="input-group">
                                        <Input
                                            type="text"
                                            placeholder={t('Ex: EMP001')}
                                            value={badgeNumber}
            ...
            <Modal isOpen={kioskModal} toggle={() => setKioskModal(false)} size="lg" className="kiosk-modal">
                <ModalHeader toggle={() => setKioskModal(false)}>
                    ...
                    {t('Mode Kiosque - Pointage par badge')}
                </ModalHeader>
                <ModalBody className="text-center p-5">
                    ...
                    <h4 className="mb-3">{t('Scannez votre badge')}</h4>
                    <p className="text-muted mb-4">
                        {t('Présentez votre badge devant le lecteur ou saisissez votre numéro ci-dessous')}
                    </p>
                    ...
                    <Row className="justify-content-center mb-4">
                        <Col md={10}>
                            ...
                            <small className="text-muted d-block text-center mt-2">
                                {t('👆 Cliquez sur un badge pour simuler un scan')}
                            </small>
                        </Col>
                    </Row>
                    ...
                    <div className="row justify-content-center">
                        <Col md={8}>
                            <div className="input-group input-group-lg">
                                ...
                                <Input
                                    type="text"
                                    placeholder={t('Numéro de badge (ex: EMP001)')}
                                    value={badgeNumber}
                                    onChange={(e) => setBadgeNumber(e.target.value.toUpperCase())}
                                    onKeyPress={(e) => {
                                        if (e.key === 'Enter' && badgeNumber) {
                                ...
                                >
                                    {loading ? <Spinner size="sm" /> : t('Valider')}
                                </Button>
                            </div>
                        </Col>
                    </div>
                    ...
                    {attendanceData.filter(r => r.date === formatDate(new Date())).length > 0 && (
                        <div className="mt-4 text-start">
                            <h6 className="mb-3">{t("Derniers pointages aujourd'hui")}</h6>
                            <div className="table-responsive">
                                <Table size="sm">
                                    <thead>
                                        <tr>
                                                ...
                                                <tr key={record.id}>
                                                    ...
                                                    <td>
                                                        {record.status === 'working' ? (
                                                            ...
                                                            <Badge color="success" pill>{t('Présent')}</Badge>
                                                        ) : (
            ...
            <Modal isOpen={manualModal} toggle={() => setManualModal(false)} size="lg">
                ...
                <ModalBody>
                    ...
                    <Row>
                        <Col md={6}>
                            <div className="mb-3">
                                <label className="form-label">{t("Heure d'arrivée")}</label>
                                <Input
                                    type="time"
                        ...
                        <Col md={6}>
                            <div className="mb-3">
                                <label className="form-label">{t('Heure de départ')}</label>
                                <Input
                                    type="time"
                    ...
                    <Row>
                        <Col md={6}>
                            <div className="mb-3">
                                <label className="form-label">{t('Type de pointage')}</label>
                                <Select
                        ...
                        <Col md={6}>
                            <div className="mb-3">
                                <label className="form-label">{t('Justification')}</label>
                                <Input
                                    type="text"
                                    placeholder={t('Ex: Congés, mission, etc.')}
