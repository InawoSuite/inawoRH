			...
			<Container fluid>
				...
				<Row>
					<Col lg={12}>
						<Card>
							<CardBody>
								{/* <h5 className="mb-4">Formulaire Collaborateur</h5> */}
								<Form className="collaborateur-form" onSubmit={(event) => event.preventDefault()}>
									...
									<Row className="g-3">
										...
										<Col md={6}>
											<FormGroup>
												<Label for="enfants">Nombre d'enfants à charge <span className="text-danger">*</span></Label>
										...
										<Col md={6}>
											<FormGroup>
												...
												<Input id="contact" name="contact" type="text" placeholder="Telephone" required />
											</FormGroup>
										</Col>
									</Row>
