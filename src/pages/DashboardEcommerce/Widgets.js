...
const TileBoxs = () => {
  return (
    <React.Fragment>
      ...
      <Row>
        <Col xl={12}>
          <Card className="crm-widget" style={{ border: "none" }}>
            <CardBody className="p-0">
              <Row className="row-cols-md-3 row-cols-1 g-0">
                {(tileBoxs2 || []).map((item, key) => (
                  <Col className="col-lg" key={key}>
                    <div
                    ...
                    >
                      <h5
                        className="text-uppercase fs-13"
