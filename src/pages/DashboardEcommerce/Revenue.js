                ...
                <Col xxl={12} lg={9}>
                    <Card>
                        <CardHeader className="align-items-center d-flex">
                            <h4 className="card-title mb-0 flex-grow-1">ventes Récentes</h4>
                            <div className="flex-shrink-0">
                               < Link to="/apps-nft-recent-sales" type="button" className="btn btn-soft-primary btn-sm">
                                    Voir les ventes <i className="ri-arrow-right-line align-bottom"></i>
                                </Link>
                                {/* <UncontrolledDropdown className='card-header-dropdown'>
                                    <DropdownToggle tag="a" className="text-reset dropdown-btn" role="button">
                                        <span className="fw-semibold text-uppercase fs-12">Voir les ventes</span><span className="text-muted">Popular <i className="mdi mdi-chevron-down ms-1"></i></span>
                                    </DropdownToggle>
