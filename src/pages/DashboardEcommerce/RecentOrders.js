                ...
                <Col xxl={5}>
                    <Card className="card-height-100">
                        <CardHeader className="align-items-center d-flex">
                            <h4 className="card-title mb-0 flex-grow-1">Evenements à venir</h4>
                ...
                <Col xxl={7}>
                    <Row>
                        <Col xl={6}>
                            <Card className="card-height-100">
                                <CardHeader className="align-items-center d-flex">
                                    <h4 className="card-title mb-0 flex-grow-1">Mes tâches</h4>
                                    <div className="flex-shrink-0">
                                ...
                                <CardBody className="p-0">
                                    ...
                                    <div className="align-items-center p-3 justify-content-between d-flex">
                                        ...
                                        <Button color="success" size="sm" ><i className="ri-add-line align-middle me-1"></i> Ajouter une tâche</Button>
                                    </div>
                        ...
                        <Col xl={6}>
                            <Card className="card-height-100">
                                <CardHeader className="border-bottom-dashed align-items-center d-flex">
                                    <h4 className="card-title mb-0 flex-grow-1">Activité récente</h4>
                                    <div className="flex-shrink-0">
