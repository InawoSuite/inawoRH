...
const CrmDeals = () => {
  ...
  const toggle = () => {
    ...
    document.title = "Opportunités | INAWO - Suite de Gestion"
...
/>
                    ...
                    <button className="btn btn-success" onClick={toggle} style={{ borderRadius: "20px" }}>
          ...
          <Row className="row-cols-lg-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
            {deals.map((deal, key) => (
