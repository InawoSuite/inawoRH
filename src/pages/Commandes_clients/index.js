...
const CommandesClients = () => {
  ...
  document.title = "Entrés | INAWO - Suite de Gestion"
          ...
          <Row>
            <Col lg={12}>
                      ...
                      <div className="col-md-4">
                        <div className="search-box">
                          <input
                            ...
                            placeholder={t("Rechercher une commande client")}
              ...
              <Card style={{ borderRadius: "20px" }}>
                ...
                <CardBody>
                  <NotAvailablePage description="Cette page vous permettra de consulter de vos commandes" />
