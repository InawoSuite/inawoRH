...
// e-MECeF API endpoints for URL helper
// Base endpoints
export const EMECEF_STATUS = "/status";

// Billing API
export const EMECEF_CREATE_INVOICE = "/bill";
export const EMECEF_CONFIRM_INVOICE = "/bill/{uid}";
export const EMECEF_CANCEL_INVOICE = "/bill/{uid}/cancel";
export const EMECEF_GET_PENDING_INVOICES = "/bill/pending";

// Information API
export const EMECEF_MECEFS = "/info/emcfs";
export const EMECEF_TAX_GROUPS = "/info/tax_groups";
export const EMECEF_INVOICE_TYPES = "/info/invoice_types";
export const EMECEF_PAYMENT_TYPES = "/info/payment_types";